...
export function ListEditor<T>({ items, onChange, getLabel, setLabel, makeBlank, name, singular, icon, placeholder, title, renderMeta, renderChildren }: Props<T>) {
        ...
        {items.map((item, i) => (
          ...
          >
            <div className="flex items-center gap-1 pr-1">
              ...
              <IconBadge name={icon} className="h-4 w-4 shrink-0 text-sea-700" />
              <input
